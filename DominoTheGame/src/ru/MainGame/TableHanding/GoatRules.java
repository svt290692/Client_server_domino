 ...
 * @author svt
 */
public class GoatRules extends Rules{
    ...
    public GoatRules(TableState mTable, AssetManager assetManager) {
	this.mTable = mTable;
...
//            doStep(tipEvent);
    ...
    @Override
    public void endGame() {
    moreDicesLeft = maxBoneToSide / 2;
    moreDicesRight = moreDicesLeft;

    GameStarted = false;
    curDirLeftToLeft = true;
    curDirRightToLeft = false;

    leftDiceRotation = null;
    rightDiceRotation = null;
